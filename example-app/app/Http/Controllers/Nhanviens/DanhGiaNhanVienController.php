...
class DanhGiaNhanVienController extends Controller
{
    public function index()
    {
        ...
        return view('nhanvien.danhgia.index', compact('danh_gias'));
    }

    public function create()
    {
        return view('nhanvien.danhgia.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('nhanvien.danhgia.index');
    }
    ...
    public function edit($id)
    {
        ...
        if (!$danh_gia) {
            return redirect()->route('nhanvien.danhgia.index')->with('error', 'Đánh giá không tồn tại');
        }
        return view('nhanvien.danhgia.edit', compact('danh_gia'));
    }
