            ...
            <div id="scrollbar">
                <div class="container-fluid">
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="{{ route('admin.taikhoan.index')}}">
                                    <span >Tài khoản</span>
                            </a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="{{ route('admin.danhmuc.index')}}">
                                 <span >Danh Mục</span>
                            </a>
                        </li> 

                        <li class="nav-item">
                            <a class="nav-link menu-link" href="{{ route('admin.sampham.index')}}">
                                    <span >Sản Phẩm</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="{{ route('admin.danhgia.index')}}">
                                 <span>Đánh giá</span>
                            </a>
                        </li> 
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="{{ route('admin.khuyenmai.index')}}">
